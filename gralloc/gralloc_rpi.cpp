...
static int drm_mod_open_fb0(struct drm_gralloc1_module_t *dmod, struct hw_device_t **dev)
{
		...
		const char *name, struct hw_device_t **device)
{
	  ...
	  if (!strcmp(name, GRALLOC_HARDWARE_MODULE_ID)) {
	      ...
	      android::GrallocImpl * /*gralloc1_device_t*/ dev = new android::GrallocImpl(m);
